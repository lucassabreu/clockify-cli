...
func (_m *MockFactory) Client() (api.Client, error) {
	...
	var r0 api.Client
	var r1 error
	if rf, ok := ret.Get(0).(func() (api.Client, error)); ok {
		return rf()
	}
...
func (_m *MockFactory) GetWorkspace() (dto.Workspace, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (dto.Workspace, error)); ok {
		return rf()
	}
...
func (_m *MockFactory) TimeEntryDefaults() defaults.TimeEntryDefaults {
	...
	if len(ret) == 0 {
		panic("no return value specified for TimeEntryDefaults")
	}
...
func (_c *MockFactory_TimeEntryDefaults_Call) RunAndReturn(run func() defaults.TimeEntryDefaults) *MockFactory_TimeEntryDefaults_Call {
	_c.Call.Return(run)
	return _c
}
