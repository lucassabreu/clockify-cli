...
func init() {
	...
	rootCmd.PersistentFlags().BoolP(ALLOW_NAME_FOR_ID, "", false, "allow use of project/client/tag's name when id is asked (defaults to env $"+ENV_PREFIX+"_ALLOW_NAME_FOR_ID)")
